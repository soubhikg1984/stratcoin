...
//        });
    ...
    describe('Close', function() {
        ...
        it('Should transfer all ether balance to STRATFIT Labs wallet \'Close\'', async function() {
    ...
    describe('ClaimToken', function() {
        ...
        it('Should send ether to STRATFIT according to token withdrawal proportion', async function() {
            let tokensAmount = ether(1);
            this.token.issue(this.vault.address, tokensAmount, {from: owner});
            this.token.disableTransfers(false, {from:owner});
