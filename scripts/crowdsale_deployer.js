...
//compiler related:
const CONTRACT_NAME = "StratfitCrowdsale";
...
//StratfitCrowdsale constructor params:
const startTime         = 1523157486; //(Tue, 12 Dec 2017 12:00:00 GMT)
const endTime           = startTime + 42 * DAY;
...
async function processContract(contractFilePAth) {
    ...
    StratfitCrowdsaleCompiled = copmiled.contracts[":" + CONTRACT_NAME];
    var bytecode = StratfitCrowdsaleCompiled.bytecode
    var abi = StratfitCrowdsaleCompiled.interface;
...
function deployContract() {
    ...
    new eth.Contract(JSON.parse(StratfitCrowdsaleCompiled.interface), null, {
        data: '0x' + StratfitCrowdsaleCompiled.bytecode
    })
        .deploy({
