...
contract RefundVault is Claimable {
    ...
    function RefundVault(address _etherWallet, StratfitSmartToken _token) public {
    ...
    //@dev Refund ether back to the investor in returns of proportional amount of SRT
    //back to the Stratfit`s wallet
