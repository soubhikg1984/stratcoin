...
/// @title Vesting trustee contract for Stratfit Labs token.
contract StratfitVestingTrustee is Claimable {
    using SafeMath for uint256;

    // The address of the SRT ERC20 token.
    StratfitSmartToken public token;
    ...
    /// @param _token StratfitSmartToken The address of the previously deployed SirnSmartToken smart contract.
    function StratfitVestingTrustee(StratfitSmartToken _token) public {
